...
export const PROMAX_THEME_TOKENS: ThemeTokens = {
  ...
  '--dsw-promax-accent': { light: '#3157d5', dark: '#8ea6ff' },
  '--dsw-promax-accent-strong': { light: '#2443a8', dark: '#b4c1ff' },
  '--dsw-promax-accent-soft': { light: '#edf1ff', dark: '#202841' },
  '--dsw-promax-canvas': { light: '#f5f4ef', dark: '#141518' },
  '--dsw-promax-panel': { light: '#fbfaf7', dark: '#1b1d21' },
  '--dsw-promax-panel-strong': { light: '#ffffff', dark: '#22242a' },
  '--dsw-promax-rail': { light: '#eeede7', dark: '#181a1e' },
  '--dsw-promax-grid-line': { light: 'rgba(49, 87, 213, 0.08)', dark: 'rgba(142, 166, 255, 0.08)' },
